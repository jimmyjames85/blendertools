...
# TODO instead of creating a new keyconfig (kc)... grab an existing one and append the keymap you
# TODO this way you will not have to export all the keyconfigs e.g. look at all the view3d.* mappings below
# TODO those are already defined in the 'Blender' keyconfig
...
kmi = km.keymap_items.new('view3d.f5_reload_it', 'F5', 'PRESS')
